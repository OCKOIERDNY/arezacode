...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "ArezaCode se nije uspio učitati",
  "Prozor aplikacije ArezaCode neočekivano je zatvoren",
  "ArezaCode ne reagira",
  ...
  "Instalacija aplikacije ArezaCode nije uspjela",
  ...
  "ArezaCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije ArezaCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u ArezaCode.",
  ...
  "dialog.server.description": "Promijenite na koji se ArezaCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera ArezaCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje ArezaCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte ArezaCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte ArezaCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte ArezaCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što ArezaCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite ArezaCode.",
  ...
  "help.tabs.introduction": "Radna površina ArezaCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija ArezaCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku ArezaCode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, ArezaCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "ArezaCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite ArezaCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za ArezaCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako ArezaCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li ArezaCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je ArezaCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se ArezaCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju ArezaCode.",
