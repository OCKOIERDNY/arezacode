export const dict = {
  ...
  "desktop.menu.documentation": "ArezaCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "ArezaCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het ArezaCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "ArezaCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van ArezaCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De ArezaCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in ArezaCode te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in ArezaCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in ArezaCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke ArezaCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "ArezaCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "ArezaCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ArezaCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "ArezaCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk ArezaCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "ArezaCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer ArezaCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat ArezaCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens ArezaCode opnieuw.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van ArezaCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het ArezaCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: ArezaCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de ArezaCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor ArezaCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe ArezaCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of ArezaCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van ArezaCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer ArezaCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "ArezaCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van ArezaCode.",
