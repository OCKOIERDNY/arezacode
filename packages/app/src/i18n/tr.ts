...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "ArezaCode yüklenemedi",
  "desktop.recovery.terminated": "ArezaCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "ArezaCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "ArezaCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "ArezaCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ArezaCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve ArezaCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak ArezaCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ArezaCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ArezaCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "ArezaCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde ArezaCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "ArezaCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde ArezaCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki ArezaCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "ArezaCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde ArezaCode hazır.",
  "wsl.onboarding.opencodeReady": "ArezaCode hazır.",
  "wsl.onboarding.installOpencodeIn": "ArezaCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "ArezaCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ArezaCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından ArezaCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "ArezaCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ArezaCode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: ArezaCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ArezaCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "ArezaCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "ArezaCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "ArezaCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "ArezaCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ArezaCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ArezaCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ArezaCode'un en son sürümünü kullanıyorsunuz.",
