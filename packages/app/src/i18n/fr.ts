export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'ArezaCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'ArezaCode",
  "desktop.recovery.terminated": "La fenêtre ArezaCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "ArezaCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'ArezaCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'ArezaCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans ArezaCode.",
  ...
  "dialog.server.description": "Changez le serveur ArezaCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'ArezaCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'ArezaCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour ArezaCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez ArezaCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'ArezaCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'ArezaCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe ArezaCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'ArezaCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "ArezaCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur ArezaCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour ArezaCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'ArezaCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si ArezaCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'ArezaCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'ArezaCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'ArezaCode.",
