...
export const dict = {
  ...
  "tools.docsFailed": "Documentation could not be processed. Check the engine, source URL, library, and version.",
  "tools.docsTitle": "Documentation sources",
  "tools.docsDescription": "Add an official HTTPS source matching your library version. Grounded Docs indexes it locally for keyword search without an embedding API key. Refresh sources when documentation changes.",
  "tools.library": "Library name",
  "tools.version": "Library version",
  "tools.url": "Official documentation URL",
  "tools.index": "Index source",
  "tools.refresh": "Refresh",
  "tools.remove": "Remove",
  "tools.query": "Search indexed documentation",
  "tools.search": "Search",
