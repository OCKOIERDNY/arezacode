...
export const dict = {
  ...
  "session.message.duration": "Duration {{duration}}",
  "session.panel.new-tab": "New tab",
  "session.panel.agents": "Agents",
  "session.panel.browser": "Browser",
  "session.panel.terminal": "Terminal",
  "session.panel.server": "Server",
  "session.servers.title": "Project servers",
  "session.servers.desktop": "Server controls are available for local projects in the desktop app.",
  "session.servers.empty": "No running servers or containers found for this project.",
  "session.servers.empty.title": "No running servers",
  "session.servers.error": "Could not check project servers. Try refreshing.",
  ...
  "session.servers.stopping": "Stopping…",
  "session.servers.start": "Start",
  "session.servers.starting": "Starting…",
  "session.servers.dev": "Dev server",
  "session.servers.compose": "Docker Compose",
  "session.servers.running": "Running",
  "session.servers.stopped": "Stopped",
  "session.servers.startError": "Could not start this service. Check its command and dependencies in the terminal.",
  "session.servers.exited": "Service exited with an error. Run its command in the terminal for details.",
  "session.browser.localServers": "Select a local server",
  "session.browser.noLocalServers": "No local web servers found",
  "session.panel.files": "Files",
  "session.panel.refresh": "Refresh",
  "session.agents.empty": "Subagents will appear here when this conversation delegates work.",
  "session.agents.empty.title": "No subagents",
  "session.agents.error": "Could not load subagents. Try refreshing.",
  "session.agents.running": "Running",
  "session.agents.waiting": "Needs input",
  "session.agents.retry": "Retrying",
  "session.agents.failed": "Failed",
  "session.agents.idle": "Idle",
  "session.agents.activity": "Recent activity",
  "session.agents.openConversation": "Open conversation",
  "session.agents.toolProgress": "{{done}} of {{total}} tool calls completed · {{failed}} failed",
  "session.agents.tool.pending": "Pending",
  "session.agents.tool.running": "Running",
  "session.agents.tool.completed": "Completed",
  "session.agents.tool.error": "Failed",
  "session.agents.todo.pending": "Pending",
  "session.agents.todo.in_progress": "In progress",
  "session.agents.todo.completed": "Completed",
  "session.agents.todo.cancelled": "Cancelled",
  "session.browser.address": "Enter a URL",
  "session.browser.back": "Back",
  "session.browser.forward": "Forward",
  "session.browser.reload": "Reload",
  "session.browser.stop": "Stop",
  "session.browser.external": "Open in default browser",
  ...
  "context.accounting.older": "Load 50 older requests",
  ...
  "context.health.limit": "Working input limit",
  "context.health.input": "Working input tokens",
  "context.health.finishingMessage": "Context limit reached; finishing current task.",
  "context.health.lockedMessage": "This chat is read-only. Start a new chat with the handoff to continue.",
  "context.health.preserved": "Your draft and queued messages are preserved in this chat.",
  "context.health.copy": "Copy handoff",
  "context.health.copied": "Handoff copied",
  "context.health.newChat": "Start new chat",
  "context.health.timing.last": "Last response elapsed",
  "context.health.timing.recent": "Last 5 responses: average",
  "context.health.timing.previous": "Previous 5 responses: average",
  "context.health.timing.tools": "Last response: tools",
  "context.health.timing.checks": "Last response: checks",
  "context.health.timing.wait": "Last response: waiting for you",
  "context.health.timing.other": "Last response: unclassified elapsed",
  "context.health.providerWait": "Provider waiting / retries (not recorded)",
  "context.health.elapsedNote": "Elapsed time includes tools and waiting; it is not measured model computation.",
  "context.accounting.details": "Click for session, prompt, and request totals",
  "context.accounting.output": "Output · includes reasoning",
  "context.accounting.reasoning": "Reasoning · subset of output",
  "context.accounting.cacheRead": "Cache read · subset of input",
  "context.accounting.cacheWrite": "Cache write · subset of input",
  "context.accounting.total": "Total tokens",
  "context.accounting.reported": "Provider-reported cost",
  "context.accounting.estimated": "Estimated cost",
  "context.accounting.unknown": "Unavailable cost",
  "context.accounting.attempts": "Requests and original prompts",
  "context.accounting.request": "Request / assistant ID",
  "context.accounting.prompt": "Original prompt ID",
  "context.accounting.source": "Cost source",
  ...
  "approval.ask": "Ask for approval",
  "approval.ask.description": "Ask before tool actions, including reads, edits, commands, and internet access.",
  "approval.auto": "Approve for me",
  "approval.auto.description": "Allow project reads and edits. Ask before commands, internet, or external file access.",
  ...
  "context.dashboard.sessionDetails": "Session details",
  "context.dashboard.tokenDetails": "Token and cost details",
  "context.dashboard.models": "Models",
  "context.dashboard.perCall": "Average tokens per call",
  "context.dashboard.input": "Input",
  "context.dashboard.output": "Output",
  ...
  "context.dashboard.workingContext": "Latest working context",
  "context.dashboard.diagnostics": "Full records remain available for diagnostics",
  "context.activity.orchestrator": "Orchestrator",
  "context.activity.subagent": "Subagent",
  "context.activity.decision": "Jev decisions",
  "context.activity.compression": "Headroom compression",
  "context.activity.characters": "{{input}} → {{output}} characters · {{saved}} saved",
  "context.activity.cached": "Reused cached compression",
  "context.activity.noHistory": "No recorded activity. Earlier sessions may not include integration history.",
  "context.activity.childrenError": "Complete activity history could not be loaded. Showing current chat data.",
  "context.activity.older": "Show earlier activity",
  "session.jev.title": "JEV",
  "session.jev.selected": "Selected {{model}}",
  "session.jev.quickEdit": "Quick Edit · {{model}}",
  "session.jev.running": "Choosing model and task scope",
  "session.jev.failed": "Decision failed",
  "session.jev.uncertain": "No confident model selection",
  "session.jev.completed": "Decision completed",
  "session.jev.loadError": "JEV activity could not be loaded. No call is confirmed.",
  "context.task.cosmetic": "Small presentation edit",
  "context.task.fix": "Targeted fix",
  "context.task.feature": "Feature",
  "context.task.review": "Review",
  "context.task.standalone": "Independent request",
  "context.task.followup": "Follow-up correction",
  "context.timing.title": "Latest request timing",
  "context.timing.elapsed": "Elapsed",
  "context.timing.routing": "Jev",
  "context.timing.model": "Model / request",
  "context.timing.tools": "Tools / subagents",
  ...
  "tools.entire": "Entire",
  "tools.context7": "Context7",
  "tools.ponytail": "Ponytail guidance",
  "tools.managed": "App-managed",
  "tools.external": "External installation",
  "tools.missing": "Not installed",
  "tools.running": "Working…",
  "tools.lastAction": "Last action",
  "tools.storage": "{{size}} MB",
  "tools.install": "Install",
  "tools.reinstall": "Reinstall",
  "tools.check": "Check",
  "tools.rollback": "Roll back",
  ...
  "prompt.slash.group.builtin": "Commands",
  "prompt.slash.compactUnavailable": "Send a message in this chat before compacting it.",
  "prompt.slash.group.command": "Custom commands",
  "prompt.slash.group.mcp": "MCP prompts",
  "prompt.slash.group.skill": "Skills",
  "prompt.slash.origin.system": "System",
  "prompt.slash.origin.personal": "Personal",
  "prompt.slash.origin.project": "Project",
  "prompt.slash.skillTokens": "≈ {{count}} tokens for skill instructions. Extra files and messages are not included.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ArezaCode.",
  ...
  "dialog.server.description": "Switch which ArezaCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "ArezaCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking ArezaCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating ArezaCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update ArezaCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install ArezaCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before ArezaCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "context.usage.cost": "Known model cost",
  ...
  "toast.update.description": "A new version of ArezaCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ArezaCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, ArezaCode does not support MCP authentication yet.',
  ...
  "session.navigator.label": "Conversation navigation",
  "session.navigator.turn": "Jump to message {{number}}",
  "session.navigator.attachment": "Attached files",
  ...
  "sidebar.gettingStarted.line1": "ArezaCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "ArezaCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the ArezaCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for ArezaCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how ArezaCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether ArezaCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how ArezaCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when ArezaCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ArezaCode.",
