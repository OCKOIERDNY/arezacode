export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja ArezaCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać ArezaCode",
  "desktop.recovery.terminated": "Okno ArezaCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "ArezaCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować ArezaCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja ArezaCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w ArezaCode.",
  ...
  "dialog.server.description": "Przełącz serwer ArezaCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie ArezaCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie ArezaCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj ArezaCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj ArezaCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim ArezaCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja ArezaCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu ArezaCode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: ArezaCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "ArezaCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer ArezaCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla ArezaCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd ArezaCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy ArezaCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw ArezaCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania ArezaCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji ArezaCode.",
