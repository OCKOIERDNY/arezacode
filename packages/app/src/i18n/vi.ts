export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu ArezaCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được ArezaCode",
  "desktop.recovery.terminated": "Cửa sổ ArezaCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "ArezaCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được ArezaCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật ArezaCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do ArezaCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong ArezaCode.",
  ...
  "dialog.server.description": "Chuyển máy chủ ArezaCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra ArezaCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật ArezaCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật ArezaCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt ArezaCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi ArezaCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của ArezaCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm ArezaCode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: ArezaCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ ArezaCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho ArezaCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của ArezaCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem ArezaCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của ArezaCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi ArezaCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của ArezaCode.",
