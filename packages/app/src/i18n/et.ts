export const dict = {
  ...
  "desktop.recovery.loadFailed": "ArezaCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "ArezaCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "ArezaCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "ArezaCode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ArezaCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid ArezaCode'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises ArezaCode.",
  ...
  "dialog.server.description": "Lülitage, millise ArezaCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "ArezaCode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "ArezaCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ArezaCode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "ArezaCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda ArezaCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige ArezaCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui ArezaCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse ArezaCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast ArezaCode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, ArezaCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "ArezaCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage ArezaCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke ArezaCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas ArezaCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas ArezaCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas ArezaCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui ArezaCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse ArezaCode uusimat versiooni.",
