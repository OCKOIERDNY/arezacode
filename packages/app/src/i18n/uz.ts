export const dict = {
  ...
  "desktop.menu.documentation": "ArezaCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "ArezaCode menyusi",
  ...
  "desktop.recovery.loadFailed": "ArezaCode yuklanmadi",
  "desktop.recovery.terminated": "ArezaCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "ArezaCode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "ArezaCode oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "ArezaCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ArezaCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va ArezaCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va ArezaCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va ArezaCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi ArezaCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "ArezaCode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "ArezaCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "ArezaCode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "ArezaCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "ArezaCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "ArezaCode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "ArezaCode tayyor.",
  "wsl.onboarding.installOpencodeIn": "ArezaCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "ArezaCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ArezaCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra ArezaCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "ArezaCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida ArezaCode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, ArezaCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "ArezaCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi ArezaCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "ArezaCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "ArezaCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "ArezaCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "ArezaCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "ArezaCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz ArezaCode oxirgi versiyasini ishga tushiryapsiz.",
