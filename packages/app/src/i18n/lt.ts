...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "ArezaCode įkelti nepavyko",
  "ArezaCode langas netikėtai užsidarė",
  "ArezaCode neatsako",
  ...
  "ArezaCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "ArezaCode neįdiegtas distributyve {{distro}}",
  "ArezaCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami ArezaCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius ArezaCode.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio ArezaCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama ArezaCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas ArezaCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite ArezaCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite ArezaCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad ArezaCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują ArezaCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą ArezaCode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad ArezaCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "ArezaCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "ArezaCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite ArezaCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite ArezaCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip ArezaCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar ArezaCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite ArezaCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas ArezaCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią ArezaCode versiją.",
