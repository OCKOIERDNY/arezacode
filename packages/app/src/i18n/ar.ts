export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل ArezaCode",
  "desktop.recovery.terminated": "توقفت نافذة ArezaCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "ArezaCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت ArezaCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث ArezaCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في ArezaCode.",
  ...
  "dialog.server.description": "تبديل خادم ArezaCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من ArezaCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث ArezaCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث ArezaCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت ArezaCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن ArezaCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على ArezaCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح ArezaCode.",
  ...
  "help.tabs.introduction": "أصبح ArezaCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من ArezaCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق ArezaCode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن ArezaCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن ArezaCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم ArezaCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ ArezaCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور ArezaCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان ArezaCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة ArezaCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل ArezaCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من ArezaCode.",
