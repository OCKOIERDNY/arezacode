...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "ArezaCode failed to load",
  "desktop.recovery.terminated": "ArezaCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "ArezaCode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "ArezaCode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ArezaCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
