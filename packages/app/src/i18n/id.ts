export const dict = {
  ...
  "desktop.recovery.loadFailed": "ArezaCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela ArezaCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "ArezaCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi ArezaCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan ArezaCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di ArezaCode.",
  ...
  "dialog.server.description": "Ganti server ArezaCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa ArezaCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui ArezaCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui ArezaCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal ArezaCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum ArezaCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru ArezaCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim ArezaCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: ArezaCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server ArezaCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk ArezaCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan ArezaCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah ArezaCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat ArezaCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru ArezaCode.",
