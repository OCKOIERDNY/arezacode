export const dict = {
  ...
  "desktop.recovery.loadFailed": "ArezaCode kunde inte läsas in",
  "desktop.recovery.terminated": "ArezaCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "ArezaCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av ArezaCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ArezaCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i ArezaCode.",
  ...
  "dialog.server.description": "Växla vilken ArezaCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar ArezaCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar ArezaCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera ArezaCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera ArezaCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan ArezaCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan ArezaCode igen.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av ArezaCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till ArezaCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, ArezaCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör ArezaCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för ArezaCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur ArezaCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om ArezaCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa ArezaCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när ArezaCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av ArezaCode.",
