export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de ArezaCode",
  ...
  "desktop.menu.ariaLabel": "Menú de ArezaCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar ArezaCode",
  "desktop.recovery.terminated": "La ventana de ArezaCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "ArezaCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar ArezaCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de ArezaCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en ArezaCode.",
  ...
  "dialog.server.description": "Cambiar el servidor de ArezaCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando ArezaCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando ArezaCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza ArezaCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala ArezaCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que ArezaCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de ArezaCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de ArezaCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: ArezaCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor ArezaCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para ArezaCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve ArezaCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si ArezaCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ArezaCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia ArezaCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de ArezaCode.",
