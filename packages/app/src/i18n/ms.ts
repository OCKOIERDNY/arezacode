export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi ArezaCode",
  ...
  "desktop.recovery.loadFailed": "ArezaCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap ArezaCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "ArezaCode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan ArezaCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini ArezaCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam ArezaCode.",
  ...
  "dialog.server.description": "Tukar pelayan ArezaCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak ArezaCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini ArezaCode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini ArezaCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang ArezaCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum ArezaCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu ArezaCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan ArezaCode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, ArezaCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan ArezaCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk ArezaCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa ArezaCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada ArezaCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema ArezaCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila ArezaCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini ArezaCode.",
