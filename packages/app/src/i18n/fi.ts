export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ArezaCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja ArezaCodessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja ArezaCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja ArezaCodessa.",
  ...
  "dialog.server.description": "Vaihda ArezaCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan ArezaCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan ArezaCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään ArezaCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään ArezaCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä ArezaCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna ArezaCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin ArezaCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten ArezaCode uudelleen.",
  ...
  "toast.update.description": "ArezaCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä ArezaCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että ArezaCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita ArezaCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda ArezaCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä ArezaCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö ArezaCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta ArezaCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun ArezaCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät ArezaCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "ArezaCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "ArezaCode-valikko",
  ...
  "desktop.recovery.loadFailed": "ArezaCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "ArezaCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "ArezaCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "ArezaCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ArezaCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "ArezaCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
