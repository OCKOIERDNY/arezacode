...
export const dict = {
  ...
  "desktop.menu.documentation": "ArezaCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "ArezaCode-meny",
  ...
  "desktop.recovery.loadFailed": "ArezaCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "ArezaCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "ArezaCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av ArezaCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av ArezaCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ArezaCode.",
  ...
  "dialog.server.description": "Bytt hvilken ArezaCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av ArezaCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ArezaCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ArezaCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør ArezaCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ArezaCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ArezaCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om ArezaCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i ArezaCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ArezaCode starter",
  ...
  "settings.updates.toast.latest.title": "ArezaCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ArezaCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker ArezaCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer ArezaCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater ArezaCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer ArezaCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før ArezaCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter ArezaCode på nytt.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
