export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in ArezaCode.",
  ...
  "dialog.server.description": "Cambia il server ArezaCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo ArezaCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento ArezaCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna ArezaCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa ArezaCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che ArezaCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di ArezaCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team ArezaCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: ArezaCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server ArezaCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per ArezaCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di ArezaCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se ArezaCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di ArezaCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di ArezaCode",
  ...
  "settings.updates.toast.latest.title": "ArezaCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di ArezaCode.",
  ...
  "desktop.menu.documentation": "Documentazione di ArezaCode",
  ...
  "desktop.menu.ariaLabel": "Menu ArezaCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare ArezaCode",
  "desktop.recovery.terminated": "La finestra di ArezaCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "ArezaCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di ArezaCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di ArezaCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
