export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do ArezaCode",
  ...
  "desktop.menu.ariaLabel": "Menu do ArezaCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o ArezaCode",
  "desktop.recovery.terminated": "A janela do ArezaCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O ArezaCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do ArezaCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O ArezaCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do ArezaCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no ArezaCode.",
  ...
  "dialog.server.description": "Trocar para qual servidor ArezaCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o ArezaCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o ArezaCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o ArezaCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "O ArezaCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O ArezaCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o ArezaCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o ArezaCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O ArezaCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o ArezaCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o ArezaCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do ArezaCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do ArezaCode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: ArezaCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor ArezaCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do ArezaCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o ArezaCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o ArezaCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o ArezaCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o ArezaCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do ArezaCode.",
