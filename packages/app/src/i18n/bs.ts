export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za ArezaCode",
  ...
  "desktop.menu.ariaLabel": "ArezaCode meni",
  ...
  "desktop.recovery.loadFailed": "ArezaCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor ArezaCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "ArezaCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija ArezaCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje ArezaCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ArezaCode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ArezaCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ArezaCode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se ArezaCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera ArezaCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje ArezaCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj ArezaCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj ArezaCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi ArezaCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija ArezaCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ArezaCode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ArezaCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni ArezaCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ArezaCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako ArezaCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li ArezaCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ArezaCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ArezaCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ArezaCode-a.",
