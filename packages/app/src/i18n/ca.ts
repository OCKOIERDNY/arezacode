export const dict = {
  ...
  "desktop.menu.documentation": "ArezaCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú ArezaCode.",
  ...
  "desktop.recovery.loadFailed": "ArezaCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra ArezaCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "ArezaCode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de ArezaCode ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ArezaCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a ArezaCode.",
  ...
  "dialog.server.description": "Canvia a quin ArezaCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant ArezaCode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant ArezaCode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza ArezaCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització ArezaCode",
  "wsl.onboarding.opencodeReadyIn": "ArezaCode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "ArezaCode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu ArezaCode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que ArezaCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir ArezaCode.",
  ...
  "help.tabs.introduction": "ArezaCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de ArezaCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip ArezaCode.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que ArezaCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "ArezaCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor ArezaCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a ArezaCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu ArezaCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si ArezaCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de ArezaCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï ArezaCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de ArezaCode.",
