export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ArezaCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i ArezaCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i ArezaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i ArezaCode.",
  ...
  "dialog.server.description": "Skift hvilken ArezaCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker ArezaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker ArezaCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer ArezaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer ArezaCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater ArezaCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater ArezaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ArezaCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før ArezaCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "ArezaCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter ArezaCode igen.",
  ...
  "toast.update.description": "En ny version af ArezaCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ArezaCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ArezaCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ArezaCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør ArezaCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ArezaCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan ArezaCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om ArezaCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas ArezaCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ArezaCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ArezaCode.",
  ...
  "desktop.recovery.loadFailed": "ArezaCode kunne ikke indlæses",
  "desktop.recovery.terminated": "ArezaCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af ArezaCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ArezaCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af ArezaCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "ArezaCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
