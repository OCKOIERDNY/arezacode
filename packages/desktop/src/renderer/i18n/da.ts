export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af ArezaCode er blevet downloadet. Vil du installere den og genstarte?",
