export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av ArezaCode har laddats ned. Vill du installera den och starta om programmet?",
