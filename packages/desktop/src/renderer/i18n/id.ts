export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "ArezaCode versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
