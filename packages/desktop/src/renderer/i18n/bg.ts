export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от ArezaCode е изтеглена. Искате ли да я инсталирате и рестартирате?",
