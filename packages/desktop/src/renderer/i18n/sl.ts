export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} ArezaCode je bila prenesena, jo želite namestiti in znova zagnati?",
