export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} ArezaCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
