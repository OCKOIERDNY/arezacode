export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i ArezaCode është shkarkuar, dëshironi ta instaloni dhe rinisni?",
