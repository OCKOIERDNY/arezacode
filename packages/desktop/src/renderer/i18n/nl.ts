export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van ArezaCode is gedownload. Wil je deze installeren en ArezaCode opnieuw starten?",
