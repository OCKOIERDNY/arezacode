export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од ArezaCode је преузета, да ли желите да је инсталирате и поново покренете?",
