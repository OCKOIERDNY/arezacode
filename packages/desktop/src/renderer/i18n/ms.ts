export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} ArezaCode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
