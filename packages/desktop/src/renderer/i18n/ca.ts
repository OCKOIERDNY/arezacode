export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'ArezaCode. Voleu instal·lar-la i reiniciar l'aplicació?",
