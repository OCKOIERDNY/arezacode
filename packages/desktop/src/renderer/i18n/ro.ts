export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} ArezaCode a fost descărcată. Vrei să o instalezi și să repornești?",
