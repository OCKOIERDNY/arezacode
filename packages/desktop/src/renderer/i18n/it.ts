export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di ArezaCode è stata scaricata. Vuoi installarla e riavviare l'app?",
