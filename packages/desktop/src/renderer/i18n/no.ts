export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av ArezaCode er lastet ned. Vil du installere den og starte på nytt?",
