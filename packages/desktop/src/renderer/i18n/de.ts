export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von ArezaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von ArezaCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
